...
| pconlife                                                                                       | 下载不同内核版本windows里的系统文件,Patch windows中的系统文件，但是windows不同版本里面的文件也不完全一样，把所有版本都装一遍肯定不现实 | https\://www\.pconlife.com/         | <https://www.pconlife.com/>                                                                                                                                                                          |
